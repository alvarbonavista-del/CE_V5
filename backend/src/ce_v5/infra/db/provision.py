...
def main() -> None:
    ...
    El rol de aplicacion es obligatorio. El de operador se provisiona solo si
    su contrasena esta en el entorno (CE_V5_OPERATOR_DB_PASSWORD): asi un
    entorno de solo runtime no necesita conocerla (CA-03).
    """
