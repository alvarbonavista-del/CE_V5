...
Declara las 11 familias CERRADAS: las 10 base de ADR-004 mas policy
(ADR-021) y la convencion de naming dominio.accion. NO define tipos de
evento concretos: cada tipo nuevo dentro de una familia lo declara su
componente en su pieza (gobernanza ADR-004). Aqui solo vive la taxonomia
base; familia nueva = ADR.
"""
...
def validate_event_type(value: str) -> str:
    ...
    debe ser una de las 11 familias cerradas; la accion es snake_case.
    """
